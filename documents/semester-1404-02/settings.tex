...
\fancypagestyle{aftertitle}{%
	\fancyhf{}
	\lhead{\small\parbox{0.25\textwidth}{\raggedright\Semester}}
	\chead{\small\parbox{0.4\textwidth}{\centering\CourseTitle}}
	\rhead{\small\parbox{0.25\textwidth}{\raggedleft\DocTitle}}
...
% (10) Fix line's width
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Allow TeX to add extra stretch between words to avoid overfull boxes
