...
\texttt{'n\textbackslash '} می‌باشد؛ اما مقدار دیفالت \lr{reference}
typeها همیشه \lr{\texttt{null}} است که در مباحث مربوط به \lr{OOP} راجع
به آن‌ها مطالعه خواهید کرد.
...
\paragraph{\texttt{System.arraycopy}}
...
با مقدار دیفالت typeشان پر می‌شوند.
