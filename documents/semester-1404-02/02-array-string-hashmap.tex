...
در این بخش آموختید که:

\begin{itemize}
\tightlist
\item
  آرایه‌ی ساده در جاوا چیست و چطور می‌توانیم از آن استفاده کنیم.
\item
  آرایه‌ی چندبعدی چیست و چه کاربردهایی دارد.
\item
  کلاس \lr{\texttt{ArrayList}} در جاوا چیست، چه تفاوت‌هایی با آرایه‌ی ساده
  دارد، و متدهای اصلیِ آن (مانند \lr{\texttt{add}} ، \lr{\texttt{remove}}
  ، و\ldots) چیست.
\item
  کلاس \lr{\texttt{String}} در جاوا برای ذخیره‌ی رشته‌ها چطور کار می‌کند و
  برخی از متدهای آن مثل \lr{\texttt{charAt}} ، \lr{\texttt{equals}} ،
  و\ldots{} چطور می‌توانند به ما کمک کنند.
\item
  کلاس \lr{\texttt{HashMap}} در جاوا چیست، و \lr{key} و \lr{value} چه
  معنایی دارند. همچنین باید با متدهای اصلی این کلاس مثل
  \lr{\texttt{get}} و \lr{\texttt{put}} آشنا باشید.
\item
  حلقه‌های \lr{enhanced for} در جاوا چه کاربردی دارند و بتوانید از آن
  برای پیمایش یک آرایه یا هش‌مپ استفاده کنید.
\end{itemize}
