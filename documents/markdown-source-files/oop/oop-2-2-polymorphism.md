...
پاسخ مثبته. در واقع کلاس‌ها هم مثل متدها و باقی اجزا، می‌تونن هر جایی از کد شما و در هر Scope ای از کد تعریف بشوند. البته همونطور که اول کار گفتم، این موضوع قید و شرط‌هایی هم دارد و سطح دسترسی ما به اون کلاس هم وابسته به جاییه که تعریف شده. جلوتر مثال‌هایی می‌بینیم که بهتر متوجه بشیم.

### کار با inner class ها
...
حالا که خودمون یک مثال نوشتیم و فهمیدیم که Anonymous Class ها چطور کار می‌کنن، بیاید برگردیم عقب و کد گرافیکی‌مون رو رمزگشایی کنیم.
