...
- مقایسه **interfac ها** و **abstract class ها** و اینکه چرا نمی‌توان به‌صورت مستقیم از آنها شیء ساخت
- خاصیت ارث‌بری چندگانه‌ی از اینترفیس‌ها
- آشنایی با انواع **polymorphism ها** و کاربرد آن‌ها
- آشنایی با انواع و نحوه **casting** در **primitive type ها** و **refrence type ها** و خطرات احتمالی آن
- اتفاقات درون حافظه هنگام **casting** در **refrences type ها**
- متد های ناآشنا که توسط ما تعریف نشده اند اما قابل استتفاده اند، چه ارتباطی با کلاس **Object** دارند
