...
در این داکیومنت و داکیومنت‌های بعدی، با شی‌گرایی آشنا می‌شویم. شی‌گرایی یا object-oriented programming (به اختصار OOP )،  طرز فکری است برای تقسیم یک برنامهٔ بزرگ، به واحدهای کوچک‌تر به اسم class . خیلی از چیزهایی که قبلا به شما گفته بودیم «در آینده برایتان توضیح می‌دهیم» را قرار است این‌جا برایتان توضیح دهیم!
