...
همانطور که می‌­بینید، `moveTo` همان مقادیری را چاپ می­‌کند که به آن ورودی دادیم؛ اما اگر بخواهیم ماشین را حرکت بدهیم، باید بتوانیم مختصاتش را تغییر دهیم، ولی چطور می­‌توانیم به فیلد های `x` و `y` که مربوط به آبجکتمان هستند دسترسی پیدا کنیم؟
