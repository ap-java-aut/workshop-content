...
متغیر های یک کلاس، یا field ها، ویژگی‌های اون کلاس را نشون می‌دهند. شما تا الآن تعداد خوبی field برای کلاس student تعریف کردید و با اون‌ها آشنا شدید:
...
به این ویژگی‌ها، ویژگی‌های `static`می‌گیم. اون‌ها به خود class مرتبط اند و بین تمام instance های اون  class مشترکن. فیلد`static` زیر را برای دانشجوها تعریف کنید:
