...
برای این که آن‌ها را مقداردهی کنید، از کلید‌واژه‌ی new استفاده کنید:
...
حالا فیلدهای آن‌ها را مقداردهی کنید:
...
همانطور که می‌بینید در این کد ما به اجبار کدهای تکراری زیادی زده‌ایم. کدی که مربوط به بخش مقداردهی field های یک object
است سه بار تکرار شده. پس بهتر است این کدها را به یک متد تبدیل کنیم. `Constructor`  ها، متدهایی هستند که دقیقا برای همین کار به کمک ما می‌آیند.
...
می‌بینید که ظاهر این متد کمی متفاوت است!  نوع خروجی‌اش مشخص نشده و از کلیدواژه‌ی `return` نیز خبری نیست. به این متد، `Constructor` می‌گویند و وظیفه‌ی آن، مقداردهی یک object جدید از کلاس `Student` ‍است. در constructor بالا، ما برای ساخت یک `Student` جدید، سن، اسم و شماره دانشجویی‌اش را ورودی گرفته‌ایم و با استفاده از آن‌ها فیلدهای `Student` را برای object جدیدمان مقداردهی کردیم.

برای آن که از این `Constructor` استفاده کنید، کد توی `main` را با کد زیر جایگرین کنید:
