...
جاوا با این خطا به شما می‌گوید که تبدیل متغیرهای `long` به `int`، خطرناک است و می‌تواند منجر به خطاهای overflow شود. مثلا در همین مثال، عدد `10000000000L` به قدری بزرگ است که در یک متغیر `int` جا نمی‌شود و به همین خاطر تبدیل آن به یک `int` مشکلاتی برای شما به همراه دارد.
...
خروجی این کد به این شکل زیر است:
