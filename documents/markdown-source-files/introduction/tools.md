...
ابتدا وارد [وبسایت گیت‌هاب](https://github.com/) می‌شویم. با انتخاب دکمه Sign up، یک صفحه به شکل صفحه پایین باز می‌شود که شما باید اطلاعات شخصی خود را در آن وارد کنید. توجه کنید که در قسمت ایمیل از ایمیل شخصی خود استفاده کنید و نه ایمیل دانشگاهی.
