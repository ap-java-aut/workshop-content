...
در نسخهٔ ساده‌تر، متد main بدون public و static نوشته شده است تا تمرکز شما فقط روی ساختار کلی برنامه باشد. اما از اینجا به بعد از شکل کامل آن استفاده می‌کنیم، زیرا این دقیقاً همان شکلی است که ماشین مجازی جاوا (JVM) برای اجرای برنامه انتظار دارد.
...
[^۱]: شاید برایتان سوال شده‌باشد که public static void و String[] args دقیقاً به چه معناست. فعلاً لازم نیست نگران آن‌ها باشید.
  کلمات public و static به مفاهیمی در برنامه‌نویسی شی‌گرا مربوط می‌شوند که در ادامهٔ مباحث آن‌ها را به‌صورت کامل یاد خواهیم گرفت.
