...
![intellij-idea-debugger-1](photos/intellij-idea-debugger-1.png)
...
1.  روی سه نقطهٔ کنار Run در نوار بالا کلیک کنید، از بخش configuration، گزینهٔ edit را انتخاب کنید:
  ...
  ![intellij-idea-debugger-2](photos/intellij-idea-debugger-2.png)
...
![intellij-idea-debugger-3](photos/intellij-idea-debugger-3.png)
...
![intellij-idea-debugger-4](photos/intellij-idea-debugger-4.png)
...
![intellij-idea-debugger-6](photos/intellij-idea-debugger-6.png)
...
![intellij-idea-debugger-7](photos/intellij-idea-debugger-7.png)


خط هایلایت شده تغییر می‌کنه چون وارد متد `findAverage` شدیم:

![intellij-idea-debugger-8.png](photos/intellij-idea-debugger-8.png)


با زدن دکمهٔ Step Over (که با فلشی رو به جلو مشخص شده) می‌تونید به خطوط بعدی برنامه برید:

![intellij-idea-debugger-9](photos/intellij-idea-debugger-9.png)

اگر دو-سه بار این کار را تکرار کنید، از داخل `for` سر در میارید:

![intellij-idea-debugger-10](photos/intellij-idea-debugger-10.png)
...
![intellij-idea-debugger-11](photos/intellij-idea-debugger-11.png)
...
![intellij-idea-debugger-12](photos/intellij-idea-debugger-12.png)


بعد از اجرای برنامه، طبق انتظار در نقطه مشخص شده متوقف می‌شه و متغیرهای برنامه در پنجره ابزارهای دیباگ قابل مشاهده هستند.

![intellij-idea-debugger-13](photos/intellij-idea-debugger-13.png)
...
![intellij-idea-debugger-14](photos/intellij-idea-debugger-14.png)
...
![intellij-idea-debugger-15](photos/intellij-idea-debugger-15.png)

حال با وارد کردن مجدد اکسپرشن گفته شده می‌تونید متوجه تغییر در میانگین بشید، چون آرایهٔ `args` رو عوض کردین:

![intellij-idea-debugger-16](photos/intellij-idea-debugger-16.png)
...
![intellij-idea-debugger-17](photos/intellij-idea-debugger-17.png)
...
![intellij-idea-debugger-18](photos/intellij-idea-debugger-18.png)


اسم جدید متغیرتون رو انتخاب کنید، مثلا من این‌جا اسم avg رو انتخاب کردم:

![intellij-idea-debugger-19](photos/intellij-idea-debugger-19.png)
...
![intellij-idea-debugger-20](photos/intellij-idea-debugger-20.png)


بعدش، اسم این متد رو مشخص کنید و enter بزنید:

![intellij-idea-debugger-21](photos/intellij-idea-debugger-21.png)
...
![intellij-idea-debugger-22](photos/intellij-idea-debugger-22.png)
...
![intellij-idea-debugger-23](photos/intellij-idea-debugger-23.png)
...
![intellij-idea-debugger-24](photos/intellij-idea-debugger-24.png)
